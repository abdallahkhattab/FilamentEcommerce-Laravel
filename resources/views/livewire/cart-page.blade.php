            ...
            <table class="w-full">
              ...
              <tbody>
                ...
                <tr wire:key>
                  ...
                  <td class="py-4">{{ Number::currency($item['unit_amount'],'ILS') }}</td>
                  <td class="py-4">
                    <div class="flex items-center">
                  ...
                  <td class="py-4">
                    {{ Number::currency($item['total_amount'],'ILS') }}
                  </td>
                  <td>
                ...
                @empty
                <tr>
                  <td colspan="5" class="text-center py-4 text-4x1 font-semibold text-slate-500 ">Your cart is empty.</td>
                    </tr>
        ...
        <div class="md:w-1/4">
          <div class="bg-white rounded-lg shadow-md p-6">
            ...
            <div class="flex justify-between mb-2">
              <span>{{ Number::currency($grand_total, 'ILS') }}</span>
              <span>{{ Number::currency($grand_total, 'ILS') }}</span>
            </div>
            <div class="flex justify-between mb-2">
              <span>Taxes</span>
              <span>{{ Number::currency(0,'ILS') }}</span>
            </div>
            <div class="flex justify-between mb-2">
              <span>Shipping</span>
              <span>{{ Number::currency(0,'ILS') }}</span>
            ...
            <div class="flex justify-between mb-2">
              ...
              <span class="font-semibold">{{ Number::currency($grand_total,'ILS') }}</span>
            </div>
            @if ($cart_items)
