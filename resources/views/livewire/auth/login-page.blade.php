              ...
              <div class="p-4 sm:p-7">
                  ...
                  <form wire:submit.prevent="login">
                      @if (session()->has('error'))
                          <div class="mt-2 bg-red-500 border border-red-500 text-sm text-red-800 rounded-lg p-4 dark:bg-red-800/10 dark:border-red-900 dark:text-red-500 mb-4" role="alert">
                              {{ session('error') }}
                          </div>
                      @endif
