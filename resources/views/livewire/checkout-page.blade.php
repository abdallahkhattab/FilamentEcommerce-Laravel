                ...
                <div class="bg-white rounded-xl shadow p-4 sm:p-7 dark:bg-slate-900">
                    ...
                    <div class="mb-6">
                        ...
                        <div class="grid grid-cols-2 gap-4">
                            <div>
                                <label wire:model = "first_name" class="block text-gray-700 dark:text-white mb-1" for="first_name">
                                    First Name
                                </label>
                        ...
                        <div class="mt-4">
                            <label  wire:model = "street_address" class="block text-gray-700 dark:text-white mb-1" for="address">
                                Address
                            </label>
                        ...
                        <div class="grid grid-cols-2 gap-4 mt-4">
                            <div>
                                <label  wire:model = "state" class="block text-gray-700 dark:text-white mb-1" for="state">
                                    State
                                </label>
                            ...
                            <div>
                                <label   wire:model = "zip_code" class="block text-gray-700 dark:text-white mb-1" for="zip">
                                    ZIP Code
                                </label>
                    ...
                    <ul class="grid w-full gap-6 md:grid-cols-2">
                        ...
                        <li>
                            <input wire:model ="payment_method" class="hidden peer" id="hosting-big"  type="radio" value="hosting-big" value="Stripe">
